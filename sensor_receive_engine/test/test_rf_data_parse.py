import unittest
from sensor_receive_engine.rf_data_parse import rf_data_parse
...
class TestRfDataParse(unittest.TestCase):
    def test_parse_rx_code_return(self):
        ...
        result = rf_data_parse.parse_rx_code(rx_code)
    ...
    def test_parse_rx_code_temp(self):
        rx_code = 4111245
        _, _, _, data_type, data = rf_data_parse.parse_rx_code(rx_code)
    ...
    def test_parse_rx_code_volt(self):
        ...
        self.assertEqual(rf_data_parse.VOLT, data_type)
