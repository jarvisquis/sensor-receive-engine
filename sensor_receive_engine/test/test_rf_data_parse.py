import unittest
from sensor_receive_engine import data_parse
...
class TestRfDataParse(unittest.TestCase):
    def test_parse_rx_code_return(self):
        ...
        result = data_parse.parse_rx_code(rx_code)
    ...
    def test_parse_rx_code_temp(self):
        rx_code = 4111245
        _, _, _, data_type, data = data_parse.parse_rx_code(rx_code)

        self.assertEqual(data_parse.TEMP, data_type)
    ...
    def test_parse_rx_code_hum(self):
        ...
        self.assertEqual(data_parse.HUM, data_type)
    ...
    def test_parse_rx_code_hygro(self):
        ...
        self.assertEqual(data_parse.HYGRO, data_type)
    ...
    def test_parse_rx_code_volt(self):
        ...
        self.assertEqual(data_parse.VOLT, data_type)
